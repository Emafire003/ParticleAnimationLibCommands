...
import me.emafire003.dev.particleanimationlib.effects.image.BlackAndWhiteImageEffect;
...
public class BlackAndWhiteImageCommand implements PALCommand {
    ...
    private int spawnEffect(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        try{
            ...
            BlackAndWhiteImageEffect imageEffect = BlackAndWhiteImageEffect
